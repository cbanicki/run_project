run_analysis <- function() {
  ...
  tryCatch(
    ...
    warning=function(cond) {
     ...
     # Adding Summary by Activity
     Activity <- group_by(tidydata, ActivityLabel)
      
     
     # Only summarizing this view by Activity Mean
      ActivitySummary <-summarize(
        Activity,timeBodyAccelerationMagnitude_Mean = mean(timeBodyAccelerationMagnitude_Mean),
        timeGravityAccelerationMagnitude_Mean = mean(timeGravityAccelerationMagnitude_Mean),
        timeBodyAccelerationJerkMagnitude_Mean = mean(timeBodyAccelerationJerkMagnitude_Mean),
        timeBodyGyroMagnitude_Mean = mean(timeBodyGyroMagnitude_Mean),
        timeBodyGyroJerkMagnitude_Mean = mean(timeBodyGyroJerkMagnitude_Mean),
        frequencyBodyAccelerationMagnitude_Mean = mean(frequencyBodyAccelerationMagnitude_Mean),
        frequencyBodyAccelerationMagnitude_MeanFreq = mean(frequencyBodyAccelerationMagnitude_MeanFreq),
        frequencyBodyAccelerationJerkMagnitude_Mean = mean(frequencyBodyAccelerationJerkMagnitude_Mean),
        frequencyBodyAccelerationJerkMagnitude_MeanFreq = mean(frequencyBodyAccelerationJerkMagnitude_MeanFreq),
        frequencyBodyGyroMagnitude_Mean = mean(frequencyBodyGyroMagnitude_Mean),
        frequencyBodyGyroMagnitude_MeanFreq = mean(frequencyBodyGyroMagnitude_MeanFreq),
        frequencyBodyGyroJerkMagnitude_Mean = mean(frequencyBodyGyroJerkMagnitude_Mean),
        frequencyBodyGyroJerkMagnitude_MeanFreq = mean(frequencyBodyGyroJerkMagnitude_MeanFreq),
        timeBodyAccelerationMagnitude_StandardDeviation = mean(timeBodyAccelerationMagnitude_StandardDeviation),
        timeGravityAccelerationMagnitude_StandardDeviation = mean(timeGravityAccelerationMagnitude_StandardDeviation),
        timeBodyAccelerationJerkMagnitude_StandardDeviation = mean(timeBodyAccelerationJerkMagnitude_StandardDeviation),
        timeBodyGyroMagnitude_StandardDeviation = mean(timeBodyGyroMagnitude_StandardDeviation),
        timeBodyGyroJerkMagnitude_StandardDeviation = mean(timeBodyGyroJerkMagnitude_StandardDeviation),
        frequencyBodyAccelerationMagnitude_StandardDeviation = mean(frequencyBodyAccelerationMagnitude_StandardDeviation),
        frequencyBodyAccelerationJerkMagnitude_StandardDeviation = mean(frequencyBodyAccelerationJerkMagnitude_StandardDeviation),
        frequencyBodyGyroMagnitude_StandardDeviation = mean(frequencyBodyGyroMagnitude_StandardDeviation),
        frequencyBodyGyroJerkMagnitude_StandardDeviation = mean(frequencyBodyGyroJerkMagnitude_StandardDeviation)
      )
      
  
      # Printing Summary View by activity
      print(ActivitySummary)
      
      # Write tidy data to a file
      write.table(ActivitySummary, file = "975119_getdata-035_ActivitySummary.txt", row.names = FALSE)
